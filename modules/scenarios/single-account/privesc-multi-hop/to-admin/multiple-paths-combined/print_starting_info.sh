...
EC2_ADMIN_ROLE_ARN=$(echo "$MODULE_OUTPUT" | jq -r '.ec2_admin_role_arn')
LAMBDA_ADMIN_ROLE_ARN=$(echo "$MODULE_OUTPUT" | jq -r '.lambda_admin_role_arn')
CLOUDFORMATION_ADMIN_ROLE_ARN=$(echo "$MODULE_OUTPUT" | jq -r '.cloudformation_admin_role_arn')
...
echo "PRIVESC_ROLE_ARN=$PRIVESC_ROLE_ARN"
echo "EC2_ADMIN_ROLE_ARN=$EC2_ADMIN_ROLE_ARN"
echo "LAMBDA_ADMIN_ROLE_ARN=$LAMBDA_ADMIN_ROLE_ARN"
echo "CLOUDFORMATION_ADMIN_ROLE_ARN=$CLOUDFORMATION_ADMIN_ROLE_ARN"
