...
STARTING_USER_ARN=$(echo "$MODULE_OUTPUT" | jq -r '.privesc_user_arn')
...
echo "PRIVESC_USER=pl-prod-one-hop-createaccesskey-bucket-privesc-user"
echo "PRIVESC_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-one-hop-createaccesskey-bucket-privesc-user"
echo "BUCKET_ACCESS_USER=pl-prod-one-hop-createaccesskey-bucket-access-user"
echo "BUCKET_ACCESS_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-one-hop-createaccesskey-bucket-access-user"
