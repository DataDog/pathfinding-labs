...
echo "STARTING_USER=pl-prod-gcd-to-bucket-starting-user"
echo "TARGET_ROLE=pl-prod-gcd-to-bucket-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-gcd-to-bucket-target-role"
