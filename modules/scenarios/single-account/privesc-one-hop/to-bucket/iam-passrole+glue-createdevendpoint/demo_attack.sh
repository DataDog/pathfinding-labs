...
# Configuration
STARTING_USER="pl-prod-gcd-to-bucket-starting-user"
TARGET_ROLE="pl-prod-gcd-to-bucket-target-role"
ENDPOINT_NAME="pl-gcd-demo-endpoint"
SSH_KEY_PATH="/tmp/pl-gcd-demo-key"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_bucket_iam_passrole_glue_createdevendpoint.value // empty')
...
ssh-keygen -t rsa -b 2048 -f ${SSH_KEY_PATH} -N "" -C "pl-gcd-demo" > /dev/null 2>&1
