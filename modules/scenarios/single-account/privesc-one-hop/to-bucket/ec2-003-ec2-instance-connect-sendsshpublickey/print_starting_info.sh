...
echo "STARTING_USER=pl-prod-ec2-003-to-bucket-starting-user"
echo "EC2_BUCKET_ROLE=pl-prod-ec2-003-to-bucket-ec2-bucket-role"
echo "EC2_BUCKET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ec2-003-to-bucket-ec2-bucket-role"
