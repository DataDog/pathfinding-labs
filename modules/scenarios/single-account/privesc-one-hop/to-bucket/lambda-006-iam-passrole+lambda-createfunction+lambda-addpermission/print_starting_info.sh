...
echo "STARTING_USER=pl-prod-lambda-006-to-bucket-starting-user"
echo "TARGET_ROLE=pl-prod-lambda-006-to-bucket-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-lambda-006-to-bucket-target-role"
