...
echo "STARTING_USER=pl-prod-dakcak-to-bucket-starting-user"
echo "TARGET_USER=pl-prod-dakcak-to-bucket-target-user"
echo "TARGET_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-dakcak-to-bucket-target-user"
