...
# Resource naming convention: pl-prod-eic-to-bucket-{resource-type}
...
resource "aws_s3_bucket" "target_bucket" {
  provider = aws.prod
  bucket   = "pl-sensitive-data-eic-${var.account_id}-${var.resource_suffix}"

  tags = {
    Name        = "pl-sensitive-data-eic-bucket"
...
resource "aws_iam_role" "ec2_bucket_role" {
  provider = aws.prod
  name     = "pl-prod-eic-to-bucket-ec2-bucket-role"
...
resource "aws_iam_role_policy" "ec2_bucket_access" {
  provider = aws.prod
  name     = "pl-prod-eic-to-bucket-s3-policy"
...
resource "aws_iam_instance_profile" "ec2_bucket_profile" {
  provider = aws.prod
  name     = "pl-prod-eic-to-bucket-instance-profile"
...
resource "aws_instance" "target" {
  ...
  tags = {
    Name        = "pl-prod-eic-to-bucket-target-instance"
    Environment = var.environment
    Scenario    = "ec2-instance-connect-sendsshpublickey"
...
resource "aws_iam_user" "starting_user" {
  provider = aws.prod
  name     = "pl-prod-eic-to-bucket-starting-user"
...
resource "aws_iam_user_policy" "starting_user_policy" {
  provider = aws.prod
  name     = "pl-prod-eic-to-bucket-starting-user-policy"
  user     = aws_iam_user.starting_user.name
