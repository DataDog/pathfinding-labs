...
echo "STARTING_USER=pl-prod-eic-to-bucket-starting-user"
echo "EC2_BUCKET_ROLE=pl-prod-eic-to-bucket-ec2-bucket-role"
echo "EC2_BUCKET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-eic-to-bucket-ec2-bucket-role"
