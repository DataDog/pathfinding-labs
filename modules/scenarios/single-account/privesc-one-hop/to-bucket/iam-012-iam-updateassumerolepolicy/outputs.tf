...
output "attack_path" {
  ...
  value       = "User (pl-prod-iam-012-to-bucket-starting-user) → AssumeRole → Role (pl-prod-iam-012-to-bucket-starting-role) → UpdateAssumeRolePolicy (target role) → AssumeRole → Target Role → S3 Bucket Access"
}
