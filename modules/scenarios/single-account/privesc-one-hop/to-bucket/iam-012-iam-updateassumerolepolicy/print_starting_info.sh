...
echo "STARTING_USER=pl-prod-iam-012-to-bucket-starting-user"
echo "STARTING_ROLE=pl-prod-iam-012-to-bucket-starting-role"
echo "STARTING_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-iam-012-to-bucket-starting-role"
echo "TARGET_ROLE=pl-prod-iam-012-to-bucket-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-iam-012-to-bucket-target-role"
