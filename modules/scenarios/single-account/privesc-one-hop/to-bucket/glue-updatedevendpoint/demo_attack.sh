...
# Configuration
STARTING_USER="pl-prod-gud-to-bucket-starting-user"
TARGET_ROLE="pl-prod-gud-to-bucket-target-role"
SSH_KEY_PATH="/tmp/pl-gud-demo-key"
...
ssh-keygen -t rsa -b 2048 -f ${SSH_KEY_PATH} -N "" -C "pl-gud-demo" > /dev/null 2>&1
