...
echo "STARTING_USER=pl-prod-iam-004-bucket-starting-user"
echo "HOP1_USER=pl-prod-iam-004-bucket-hop1"
echo "HOP1_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-004-bucket-hop1"
