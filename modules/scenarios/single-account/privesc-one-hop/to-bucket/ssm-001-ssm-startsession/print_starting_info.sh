...
echo "STARTING_USER=pl-prod-ssm-001-to-bucket-starting-user"
echo "EC2_BUCKET_ROLE=pl-prod-ssm-001-to-bucket-ec2-role"
echo "EC2_BUCKET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ssm-001-to-bucket-ec2-role"
