...
echo "STARTING_USER=pl-prod-iam-006-to-bucket-starting-user"
echo "BUCKET_USER=pl-prod-iam-006-to-bucket-user"
echo "BUCKET_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-006-to-bucket-user"
