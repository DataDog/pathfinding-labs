...
echo "STARTING_USER=pl-prod-iam-003-to-bucket-starting-user"
echo "TARGET_USER=pl-prod-iam-003-to-bucket-target-user"
echo "TARGET_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-003-to-bucket-target-user"
