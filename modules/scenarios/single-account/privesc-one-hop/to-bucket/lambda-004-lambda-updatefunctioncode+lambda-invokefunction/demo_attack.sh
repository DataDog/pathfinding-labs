...
# Wait for Lambda to finish processing the code update
echo -e "${YELLOW}Waiting 15 seconds for Lambda to process the code update${NC}"
sleep 15
echo -e "${GREEN}✓ Lambda function code update applied${NC}\n"
