...
echo "STARTING_USER=pl-prod-clp-bucket-starting-user"
echo "HOP1_USER=pl-prod-clp-bucket-hop1"
echo "HOP1_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-clp-bucket-hop1"
