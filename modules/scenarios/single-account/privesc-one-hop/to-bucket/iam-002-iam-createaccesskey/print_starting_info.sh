...
echo "PRIVESC_USER=pl-prod-iam-002-to-bucket-privesc-user"
echo "PRIVESC_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-002-to-bucket-privesc-user"
echo "BUCKET_ACCESS_USER=pl-prod-iam-002-to-bucket-access-user"
echo "BUCKET_ACCESS_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-002-to-bucket-access-user"
