...
# Configuration
STARTING_USER="pl-prod-sss-to-bucket-starting-user"
EC2_BUCKET_ROLE="pl-prod-sss-to-bucket-ec2-bucket-role"
...
echo -e "  → (Extract Credentials via IMDS) → $EC2_BUCKET_ROLE → S3 Bucket"
