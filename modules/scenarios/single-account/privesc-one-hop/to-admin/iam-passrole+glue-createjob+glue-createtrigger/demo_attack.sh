...
# Configuration
STARTING_USER="pl-prod-gcj-ct-to-admin-starting-user"
TARGET_ROLE="pl-prod-gcj-ct-to-admin-target-role"
RANDOM_SUFFIX=$(date +%s | tail -c 6)
JOB_NAME="pl-gcj-ct-demo-job-${RANDOM_SUFFIX}"
TRIGGER_NAME="pl-gcj-ct-demo-trigger-${RANDOM_SUFFIX}"
