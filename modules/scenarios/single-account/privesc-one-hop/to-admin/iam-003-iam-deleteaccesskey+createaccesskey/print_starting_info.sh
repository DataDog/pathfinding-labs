...
echo "STARTING_USER=pl-prod-iam-003-to-admin-starting-user"
echo "ADMIN_USER=pl-prod-iam-003-to-admin-target-user"
echo "ADMIN_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-003-to-admin-target-user"
