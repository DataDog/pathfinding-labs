...
echo "STARTING_USER=pl-prod-ssm-001-to-admin-starting-user"
echo "EC2_ADMIN_ROLE=pl-prod-ssm-001-to-admin-ec2-role"
echo "EC2_ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ssm-001-to-admin-ec2-role"
