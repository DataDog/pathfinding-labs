...
echo "STARTING_USER=pl-prod-prcuss-to-admin-starting-user"
echo "ADMIN_ROLE_NAME=pl-prod-prcuss-to-admin-stackset-admin-role"
echo "ADMIN_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-prcuss-to-admin-stackset-admin-role"
echo "EXECUTION_ROLE_NAME=pl-prod-prcuss-to-admin-stackset-execution-role"
echo "EXECUTION_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-prcuss-to-admin-stackset-execution-role"
echo "ESCALATED_ROLE_NAME=pl-prod-prcuss-to-admin-escalated-role"
echo "ESCALATED_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-prcuss-to-admin-escalated-role"

echo ""

echo -e "${YELLOW}Existing Resources to Exploit:${NC}"
echo "EXISTING_STACKSET_NAME=pl-prod-prcuss-to-admin-stackset"
echo "EXISTING_STACKSET_ARN=arn:aws:cloudformation:${AWS_REGION}:${ACCOUNT_ID}:stackset/pl-prod-prcuss-to-admin-stackset:*"
