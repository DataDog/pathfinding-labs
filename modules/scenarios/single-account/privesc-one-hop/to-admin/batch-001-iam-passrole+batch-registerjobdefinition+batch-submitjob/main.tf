...
# =============================================================================
#
# NOTE: The Batch SLR (AWSServiceRoleForBatch) is an account-wide singleton
# and is created once by the prod environment module, not here — see
# modules/environments/prod/main.tf. Creating it again in a scenario module
# fails once it exists (either from another apply or because AWS auto-creates
# it as a side effect of the first Batch compute environment in the account).
