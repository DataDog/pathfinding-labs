...
echo "STARTING_USER=pl-prod-cak-to-admin-starting-user"
echo "ADMIN_USER=pl-prod-cak-to-admin-target-user"
echo "ADMIN_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-cak-to-admin-target-user"
