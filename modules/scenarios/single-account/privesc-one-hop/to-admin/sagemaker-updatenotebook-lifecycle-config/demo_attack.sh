...
# Configuration
STARTING_USER="pl-prod-sulc-to-admin-starting-user"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_sagemaker_updatenotebook_lifecycle_config.value // empty')
...
aws iam attach-user-policy \
    --user-name pl-prod-sulc-to-admin-starting-user \
