...
TARGET_ROLE="pl-prod-cbcpsb-to-admin-target-role"
...
phases:
  build:
    commands:
      ...
      - aws iam attach-user-policy --user-name pl-prod-cbcpsb-to-admin-starting-user --policy-arn arn:aws:iam::aws:policy/AdministratorAccess
