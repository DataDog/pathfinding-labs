...
echo "STARTING_USER=pl-prod-cloudformation-003-to-admin-starting-user"
echo "EXECUTION_ROLE=pl-prod-cloudformation-003-to-admin-execution-role"
echo "EXECUTION_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cloudformation-003-to-admin-execution-role"
echo "ADMIN_ROLE=pl-prod-cloudformation-003-to-admin-admin-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cloudformation-003-to-admin-admin-role"
echo "ESCALATED_ROLE_NAME=pl-prod-cloudformation-003-to-admin-escalated-role"
echo "ESCALATED_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cloudformation-003-to-admin-escalated-role"
