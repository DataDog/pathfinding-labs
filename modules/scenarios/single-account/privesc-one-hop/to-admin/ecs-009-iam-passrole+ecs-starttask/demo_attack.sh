...
FLAG_PARAM_NAME="/pathfinding-labs/flags/ecs-009-to-admin"
...
echo -e "  $STARTING_USER → (PassRole + StartTask with --overrides on existing task def)"
echo -e "  → ECS Task with $ADMIN_ROLE → AttachUserPolicy"
