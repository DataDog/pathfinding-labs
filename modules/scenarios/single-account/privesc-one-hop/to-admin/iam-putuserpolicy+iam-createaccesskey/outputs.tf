...
output "attack_path" {
  ...
  value       = "User (pl-prod-pupcak-to-admin-starting-user) → PutUserPolicy on target_user → CreateAccessKey for target_user → Authenticate as target_user → Admin access"
}
