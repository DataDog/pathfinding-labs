...
echo "STARTING_USER=pl-prod-uarp-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-uarp-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-uarp-to-admin-target-role"
