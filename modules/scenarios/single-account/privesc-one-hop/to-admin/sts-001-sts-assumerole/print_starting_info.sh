...
echo "STARTING_USER=pl-prod-sts-001-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-sts-001-to-admin-target-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-sts-001-to-admin-target-role"
