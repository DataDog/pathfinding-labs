...
echo "STARTING_USER=pl-prod-ecs-001-to-admin-starting-user"
echo "TARGET_ROLE_NAME=pl-prod-ecs-001-to-admin-target-role"
echo "TARGET_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ecs-001-to-admin-target-role"
