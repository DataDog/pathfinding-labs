...
output "attack_path" {
  ...
  value       = "User (pl-prod-iam-012-to-admin-starting-user) → (iam:UpdateAssumeRolePolicy) → modify pl-prod-iam-012-to-admin-target-role trust policy → (sts:AssumeRole) → Administrator"
}
