...
echo "STARTING_USER=pl-prod-iam-016-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-iam-016-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-iam-016-to-admin-target-role"
echo "TARGET_POLICY=pl-prod-iam-016-to-admin-target-policy"
