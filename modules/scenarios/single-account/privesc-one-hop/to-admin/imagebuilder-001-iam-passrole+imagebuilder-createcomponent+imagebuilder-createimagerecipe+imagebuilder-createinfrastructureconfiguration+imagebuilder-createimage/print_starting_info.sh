...
echo "STARTING_USER=pl-prod-imagebuilder-001-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-imagebuilder-001-to-admin-admin-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-imagebuilder-001-to-admin-admin-role"
echo "INSTANCE_PROFILE=pl-prod-imagebuilder-001-to-admin-admin-profile"

echo ""

echo -e "${BLUE}Attack Path:${NC}"
echo "Privilege escalation via iam:PassRole + EC2 Image Builder pipeline"
echo ""
