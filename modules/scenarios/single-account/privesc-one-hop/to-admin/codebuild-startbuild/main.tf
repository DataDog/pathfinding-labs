...
# Resource naming convention: pl-prod-cbsb-to-admin-{resource-type}
...
resource "aws_iam_user" "starting_user" {
  provider = aws.prod
  name     = "pl-prod-cbsb-to-admin-starting-user"
...
resource "aws_iam_user_policy" "starting_user_policy" {
  provider = aws.prod
  name     = "pl-prod-cbsb-to-admin-starting-user-policy"
  user     = aws_iam_user.starting_user.name
...
resource "aws_iam_role" "project_role" {
  provider = aws.prod
  name     = "pl-prod-cbsb-to-admin-project-role"
...
resource "aws_codebuild_project" "existing_project" {
  provider     = aws.prod
  name         = "pl-prod-cbsb-to-admin-existing-project"
