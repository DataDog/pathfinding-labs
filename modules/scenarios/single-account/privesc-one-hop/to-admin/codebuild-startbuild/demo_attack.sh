...
# Configuration
STARTING_USER="pl-prod-cbsb-to-admin-starting-user"
EXISTING_PROJECT="pl-prod-cbsb-to-admin-existing-project"
PROJECT_ROLE="pl-prod-cbsb-to-admin-project-role"
