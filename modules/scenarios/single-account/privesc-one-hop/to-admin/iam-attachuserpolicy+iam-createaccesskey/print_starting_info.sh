...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_iam_attachuserpolicy_iam_createaccesskey.value // empty')
...
echo "STARTING_USER=pl-prod-aupcak-to-admin-starting-user"
echo "TARGET_USER=pl-prod-aupcak-to-admin-target-user"
echo "TARGET_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-aupcak-to-admin-target-user"
echo "ADMIN_POLICY_ARN=arn:aws:iam::aws:policy/AdministratorAccess"
