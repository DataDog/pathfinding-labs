...
output "attack_path" {
  ...
  value       = "User (pl-prod-prct-to-admin-starting-user) → Upload malicious script to S3 → PassRole + CreateTrainingJob → Training job executes with admin role → Script grants admin access to starting user"
}
