...
# Configuration
STARTING_USER="pl-prod-prct-to-admin-starting-user"
PASSABLE_ROLE_NAME="pl-prod-prct-to-admin-passable-role"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_iam_passrole_sagemaker_createtrainingjob.value // empty')
