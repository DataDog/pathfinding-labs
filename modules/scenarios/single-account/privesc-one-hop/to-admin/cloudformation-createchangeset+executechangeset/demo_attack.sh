...
# Configuration
STARTING_USER="pl-prod-cfcs-to-admin-starting-user"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_cloudformation_createchangeset_executechangeset.value // empty')
...
# Step 5: Discover the existing CloudFormation stack
...
# Step 7: Create a ChangeSet for the stack
...
# Step 8: View the ChangeSet details
...
# Step 10: Verify the escalated role was created
...
# Step 11: Assume the escalated admin role
