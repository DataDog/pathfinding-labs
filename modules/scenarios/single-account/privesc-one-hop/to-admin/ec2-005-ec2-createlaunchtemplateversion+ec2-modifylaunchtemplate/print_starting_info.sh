...
echo "STARTING_USER=pl-prod-ec2-005-to-admin-starting-user"
echo "TARGET_ADMIN_ROLE=pl-prod-ec2-005-to-admin-target-role"
echo "TARGET_ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ec2-005-to-admin-target-role"
echo "TARGET_ADMIN_PROFILE=pl-prod-ec2-005-to-admin-target-profile"

echo ""

echo -e "${YELLOW}Existing Resources to Exploit:${NC}"
echo "EXISTING_LAUNCH_TEMPLATE_NAME=pl-prod-ec2-005-to-admin-victim-template"
echo "EXISTING_LAUNCH_TEMPLATE_ARN=arn:aws:ec2:${AWS_REGION}:${ACCOUNT_ID}:launch-template/*"
echo "EXISTING_ASG_NAME=pl-prod-ec2-005-to-admin-victim-asg"
