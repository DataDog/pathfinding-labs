...
echo "STARTING_USER=pl-prod-iam-015-to-admin-starting-user"
echo "TARGET_USER=pl-prod-iam-015-to-admin-target-user"
echo "TARGET_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-015-to-admin-target-user"
