...
# The target user now has AdministratorAccess attached, which grants ssm:GetParameter
...
FLAG_PARAM_NAME="/pathfinding-labs/flags/iam-015-to-admin"
...
echo -e "  $STARTING_USER → (AttachUserPolicy) → $TARGET_USER_NAME"
echo -e "  → (CreateAccessKey) → Authenticate as $TARGET_USER_NAME"
