...
echo "STARTING_USER=pl-prod-cbcpsbb-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-cbcpsbb-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cbcpsbb-to-admin-target-role"
