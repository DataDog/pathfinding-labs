...
# Configuration
STARTING_USER="pl-prod-pcfss-to-admin-starting-user"
EXECUTION_ROLE="pl-prod-pcfss-to-admin-execution-role"
ADMIN_ROLE="pl-prod-pcfss-to-admin-admin-role"
STACKSET_NAME="pl-prod-pcfss-escalation-stackset"
ESCALATED_ROLE_NAME="pl-prod-pcfss-to-admin-escalated-role"
