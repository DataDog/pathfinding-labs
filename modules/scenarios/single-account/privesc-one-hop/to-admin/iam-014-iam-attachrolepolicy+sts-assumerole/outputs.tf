...
output "attack_path" {
  ...
  value       = "User (pl-prod-iam-014-to-admin-starting-user) → AttachRolePolicy (attach AdministratorAccess) → Target Role (pl-prod-iam-014-to-admin-target-role) → AssumeRole → Administrator Access"
}
