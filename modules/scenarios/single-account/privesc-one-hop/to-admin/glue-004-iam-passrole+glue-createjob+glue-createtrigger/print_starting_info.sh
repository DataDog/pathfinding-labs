...
echo "STARTING_USER=pl-prod-glue-004-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-glue-004-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-glue-004-to-admin-target-role"
