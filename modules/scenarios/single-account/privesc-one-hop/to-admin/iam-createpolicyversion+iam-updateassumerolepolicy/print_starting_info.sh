...
echo "STARTING_USER=pl-prod-cpvuar-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-cpvuar-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cpvuar-to-admin-target-role"
echo "TARGET_POLICY=pl-prod-cpvuar-to-admin-target-policy"
