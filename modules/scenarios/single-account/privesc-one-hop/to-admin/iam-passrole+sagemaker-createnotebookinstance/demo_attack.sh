...
# Configuration
STARTING_USER="pl-prod-prcn-to-admin-starting-user"
PASSABLE_ROLE="pl-prod-prcn-to-admin-passable-role"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_iam_passrole_sagemaker_createnotebookinstance.value // empty')
