...
echo "STARTING_USER=pl-prod-precscs-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-precscs-to-admin-target-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-precscs-to-admin-target-role"
echo "TASK_EXECUTION_ROLE=pl-prod-precscs-to-admin-target-role"
echo "TASK_EXECUTION_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-precscs-to-admin-target-role"
