...
# Resource naming convention: pl-prod-precscs-to-admin-{resource-type}
# precscs = PassRole+ECS:CreateService
...
resource "aws_iam_user" "starting_user" {
  provider = aws.prod
  name     = "pl-prod-precscs-to-admin-starting-user"
...
resource "aws_iam_user_policy" "starting_user_required" {
  provider = aws.prod
  name     = "pl-prod-precscs-to-admin-required-permissions"
  user     = aws_iam_user.starting_user.name
...
resource "aws_iam_user_policy" "starting_user_helpful" {
  provider = aws.prod
  name     = "pl-prod-precscs-to-admin-helpful-permissions"
  user     = aws_iam_user.starting_user.name
...
resource "aws_iam_role" "target_role" {
  provider = aws.prod
  name     = "pl-prod-precscs-to-admin-target-role"
