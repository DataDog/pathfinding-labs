...
echo "STARTING_USER=pl-prod-cloudformation-002-to-admin-starting-user"
echo "ESCALATED_ROLE_NAME=pl-prod-cloudformation-002-to-admin-escalated-role"
echo "ESCALATED_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cloudformation-002-to-admin-escalated-role"

echo ""

echo -e "${YELLOW}Existing Resources to Exploit:${NC}"
echo "EXISTING_STACK_NAME=pl-prod-cloudformation-002-to-admin-stack"
echo "EXISTING_STACK_ARN=arn:aws:cloudformation:${AWS_REGION}:${ACCOUNT_ID}:stack/pl-prod-cloudformation-002-to-admin-stack/*"
