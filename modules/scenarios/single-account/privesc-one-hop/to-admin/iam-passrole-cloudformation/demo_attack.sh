...
# Configuration
STARTING_USER="pl-prod-pcf-starting-user"
ADMIN_ROLE="pl-prod-pcf-admin-role"
...
STARTING_ACCESS_KEY_ID=$(terraform output -raw prod_one_hop_to_admin_iam_passrole_cloudformation_starting_user_access_key_id 2>/dev/null || echo "")
STARTING_SECRET_ACCESS_KEY=$(terraform output -raw prod_one_hop_to_admin_iam_passrole_cloudformation_starting_user_secret_access_key 2>/dev/null || echo "")
...
# Step 6: Create CloudFormation stack with PassRole
...
# Step 7: Wait for stack creation to complete
...
# Step 9: Assume the escalated role
