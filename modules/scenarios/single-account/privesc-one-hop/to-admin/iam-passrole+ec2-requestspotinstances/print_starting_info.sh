...
echo "STARTING_USER=pl-prod-prrsi-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-prrsi-to-admin-target-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-prrsi-to-admin-target-role"
