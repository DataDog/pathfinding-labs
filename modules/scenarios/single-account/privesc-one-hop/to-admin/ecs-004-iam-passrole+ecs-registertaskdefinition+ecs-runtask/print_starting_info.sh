...
echo "STARTING_USER=pl-prod-ecs-004-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-ecs-004-to-admin-target-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ecs-004-to-admin-target-role"
echo "TASK_EXECUTION_ROLE=pl-prod-ecs-004-to-admin-target-role"
echo "TASK_EXECUTION_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ecs-004-to-admin-target-role"
