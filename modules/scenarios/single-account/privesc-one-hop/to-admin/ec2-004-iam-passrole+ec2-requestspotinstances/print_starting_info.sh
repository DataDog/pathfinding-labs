...
echo "STARTING_USER=pl-prod-ec2-004-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-ec2-004-to-admin-target-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ec2-004-to-admin-target-role"
