...
# Configuration
STARTING_USER="pl-prod-cpnu-to-admin-starting-user"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_sagemaker_createpresignednotebookinstanceurl.value // empty')
