...
echo "STARTING_USER=pl-prod-cpvsar-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-cpvsar-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cpvsar-to-admin-target-role"
echo "TARGET_POLICY=pl-prod-cpvsar-to-admin-target-policy"
