...
echo "STARTING_USER=pl-prod-sss-to-admin-starting-user"
echo "EC2_ADMIN_ROLE=pl-prod-sss-to-admin-ec2-role"
echo "EC2_ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-sss-to-admin-ec2-role"
