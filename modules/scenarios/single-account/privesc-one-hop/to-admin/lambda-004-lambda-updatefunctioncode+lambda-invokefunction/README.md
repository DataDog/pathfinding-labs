...
| `arn:aws:ssm:{region}:{account_id}:parameter/pathfinding-labs/flags/lambda-004-to-admin` | CTF flag stored in SSM Parameter Store; retrievable by any admin-equivalent principal |
