...
echo "STARTING_USER=pl-prod-codebuild-002-to-admin-starting-user"
echo "PROJECT_ROLE=pl-prod-codebuild-002-to-admin-project-role"
echo "PROJECT_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-codebuild-002-to-admin-project-role"

echo ""

echo -e "${YELLOW}Existing Resources to Exploit:${NC}"
echo "EXISTING_CODEBUILD_PROJECT_NAME=pl-prod-codebuild-002-to-admin-existing-project"
echo "EXISTING_CODEBUILD_PROJECT_ARN=arn:aws:codebuild:${AWS_REGION}:${ACCOUNT_ID}:project/pl-prod-codebuild-002-to-admin-existing-project"
