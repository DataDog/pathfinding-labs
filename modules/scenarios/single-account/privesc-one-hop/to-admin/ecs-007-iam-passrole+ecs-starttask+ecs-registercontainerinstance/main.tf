...
# ecs:RegisterContainerInstance can escalate privileges by exploiting an EXISTING
# task definition. Unlike ecs-005 (which requires ecs:RegisterTaskDefinition),
# the attacker here does NOT create a new task definition. Instead:
