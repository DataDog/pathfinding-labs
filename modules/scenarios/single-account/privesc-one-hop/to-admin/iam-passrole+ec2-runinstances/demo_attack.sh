...
STARTING_ACCESS_KEY_ID=$(terraform output -raw prod_one_hop_to_admin_iam_passrole_ec2_runinstances_starting_user_access_key_id 2>/dev/null || echo "")
STARTING_SECRET_ACCESS_KEY=$(terraform output -raw prod_one_hop_to_admin_iam_passrole_ec2_runinstances_starting_user_secret_access_key 2>/dev/null || echo "")
