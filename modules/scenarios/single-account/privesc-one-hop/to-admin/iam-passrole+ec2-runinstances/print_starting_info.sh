...
echo "STARTING_USER=pl-prod-prec-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-prec-to-admin-target-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-prec-to-admin-target-role"
