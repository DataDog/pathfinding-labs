...
echo "STARTING_USER=pl-prod-ecs-006-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-ecs-006-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ecs-006-to-admin-target-role"
echo "ECS_CLUSTER=pl-prod-ecs-006-to-admin-cluster"
echo "ECS_SERVICE=pl-prod-ecs-006-to-admin-service"
