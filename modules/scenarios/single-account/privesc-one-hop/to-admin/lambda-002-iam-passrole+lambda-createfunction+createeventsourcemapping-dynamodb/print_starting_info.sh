...
echo "STARTING_USER=pl-prod-lambda-002-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-lambda-002-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-lambda-002-to-admin-target-role"
echo "LAMBDA_FUNCTION_NAME=pl-prod-lambda-002-malicious-lambda"
echo "LAMBDA_FUNCTION_NAME_ARN=arn:aws:lambda:${AWS_REGION}:${ACCOUNT_ID}:function/pl-prod-lambda-002-malicious-lambda"
