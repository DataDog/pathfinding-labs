...
# Configuration
STARTING_USER="pl-prod-prpuar-to-admin-starting-user"
TARGET_ROLE="pl-prod-prpuar-to-admin-target-role"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_iam_putrolepolicy_iam_updateassumerolepolicy.value // empty')
...
echo "$CURRENT_TRUST_POLICY" > /tmp/original_trust_policy_prpuar.json
