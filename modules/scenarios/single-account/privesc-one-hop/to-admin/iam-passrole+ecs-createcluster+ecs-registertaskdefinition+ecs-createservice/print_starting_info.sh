...
echo "STARTING_USER=pl-prod-precccs-to-admin-starting-user"
echo "TARGET_ROLE_NAME=pl-prod-precccs-to-admin-target-role"
echo "TARGET_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-precccs-to-admin-target-role"
