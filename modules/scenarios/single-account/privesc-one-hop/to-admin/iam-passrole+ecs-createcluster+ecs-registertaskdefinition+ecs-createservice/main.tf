...
# Resource naming convention: pl-prod-precccs-to-admin-{resource-type}

# Scenario-specific starting user
resource "aws_iam_user" "starting_user" {
  provider = aws.prod
  name     = "pl-prod-precccs-to-admin-starting-user"
...
resource "aws_iam_user_policy" "starting_user_policy" {
  provider = aws.prod
  name     = "pl-prod-precccs-to-admin-starting-user-policy"
  user     = aws_iam_user.starting_user.name
...
resource "aws_iam_role" "target_role" {
  provider = aws.prod
  name     = "pl-prod-precccs-to-admin-target-role"
...
resource "aws_iam_role_policy" "target_role_escalation_policy" {
  provider = aws.prod
  name     = "pl-prod-precccs-to-admin-escalation-policy"
