...
# Configuration
STARTING_USER="pl-prod-precccs-to-admin-starting-user"
TARGET_ROLE_NAME="pl-prod-precccs-to-admin-target-role"
CLUSTER_NAME="pl-prod-precccs-attack-cluster"
TASK_FAMILY="pl-precccs-admin-escalation"
SERVICE_NAME="pl-prod-precccs-attack-service"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_iam_passrole_ecs_createcluster_ecs_registertaskdefinition_ecs_createservice.value // empty')
  ...
  "containerDefinitions": [
    {
      ...
      "logConfiguration": {
        ...
        "options": {
          ...
          "awslogs-group": "/ecs/pl-precccs-escalation",
