...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_ssm_sendcommand.value // empty')
...
echo "STARTING_USER=pl-prod-ssc-to-admin-starting-user"
echo "EC2_ADMIN_ROLE=pl-prod-ssc-to-admin-ec2-admin-role"
echo "EC2_ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-ssc-to-admin-ec2-admin-role"
