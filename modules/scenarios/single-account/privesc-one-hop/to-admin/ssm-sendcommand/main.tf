...
# Resource naming convention: pl-prod-ssc-to-admin-{resource-type}
...
resource "aws_iam_user" "starting_user" {
  provider = aws.prod
  name     = "pl-prod-ssc-to-admin-starting-user"
...
resource "aws_iam_user_policy" "starting_user_policy" {
  provider = aws.prod
  name     = "pl-prod-ssc-to-admin-starting-user-policy"
  user     = aws_iam_user.starting_user.name
...
resource "aws_iam_role" "ec2_admin" {
  provider = aws.prod
  name     = "pl-prod-ssc-to-admin-ec2-admin-role"
...
resource "aws_iam_instance_profile" "ec2_admin" {
  provider = aws.prod
  name     = "pl-prod-ssc-to-admin-instance-profile"
  role     = aws_iam_role.ec2_admin.name
...
resource "aws_instance" "target" {
  ...
  tags = {
    Name        = "pl-prod-ssc-to-admin-target-instance"
    Environment = var.environment
    Scenario    = "ssm-sendcommand"
