...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_iam_deleteaccesskey_createaccesskey.value // empty')
...
echo "STARTING_USER=pl-prod-dakcak-to-admin-starting-user"
echo "ADMIN_USER=pl-prod-dakcak-to-admin-target-user"
echo "ADMIN_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-dakcak-to-admin-target-user"
