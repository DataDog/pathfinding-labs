...
echo "STARTING_USER=pl-prod-iam-004-to-admin-starting-user"
echo "STARTING_ROLE=pl-prod-iam-004-to-admin-starting-role"
echo "STARTING_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-iam-004-to-admin-starting-role"
echo "ADMIN_USER=pl-prod-iam-004-to-admin-target-user"
echo "ADMIN_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-004-to-admin-target-user"
