...
# Configuration
STARTING_USER="pl-prod-lufc-to-admin-starting-user"
TARGET_LAMBDA="pl-prod-lufc-to-admin-target-lambda"
TARGET_ROLE="pl-prod-lufc-to-admin-target-role"
...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_lambda_updatefunctioncode.value // empty')
