...
# Configuration
STARTING_USER="pl-prod-precsrt-to-admin-starting-user"
ADMIN_ROLE="pl-prod-precsrt-to-admin-target-role"
TASK_DEFINITION_FAMILY="pl-precsrt-admin-escalation"
TASK_EXECUTION_ROLE="pl-prod-precsrt-to-admin-target-role"
...
# Step 7: Get default VPC and subnet for ECS task
