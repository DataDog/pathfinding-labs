...
# Configuration
STARTING_USER="pl-prod-iprlcflap-to-admin-starting-user"
ADMIN_ROLE="pl-prod-iprlcflap-to-admin-target-role"
LAMBDA_FUNCTION_NAME="pl-iprlcflap-malicious-function"
