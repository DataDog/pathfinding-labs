...
echo "STARTING_USER=pl-prod-lambda-006-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-lambda-006-to-admin-target-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-lambda-006-to-admin-target-role"
echo "LAMBDA_FUNCTION_NAME=pl-lambda-006-malicious-function"
echo "LAMBDA_FUNCTION_NAME_ARN=arn:aws:lambda:${AWS_REGION}:${ACCOUNT_ID}:function/pl-lambda-006-malicious-function"
