...
echo "STARTING_USER=pl-prod-clp-to-admin-starting-user"
echo "STARTING_ROLE=pl-prod-clp-to-admin-starting-role"
echo "STARTING_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-clp-to-admin-starting-role"
echo "ADMIN_USER=pl-prod-clp-to-admin-target-user"
echo "ADMIN_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-clp-to-admin-target-user"
