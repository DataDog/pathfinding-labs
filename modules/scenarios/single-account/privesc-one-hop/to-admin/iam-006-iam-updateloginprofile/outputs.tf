...
output "attack_path" {
  ...
  value       = "User (pl-prod-iam-006-to-admin-starting-user) → iam:UpdateLoginProfile → Admin User (pl-prod-iam-006-to-admin-target-user) → Console Access with Admin Privileges"
}
