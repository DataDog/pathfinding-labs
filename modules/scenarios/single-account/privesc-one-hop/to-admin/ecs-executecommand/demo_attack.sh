...
# Configuration
STARTING_USER="pl-prod-eec-to-admin-starting-user"
TARGET_ROLE="pl-prod-eec-to-admin-target-role"
ECS_CLUSTER="pl-prod-eec-to-admin-cluster"
ECS_SERVICE="pl-prod-eec-to-admin-service"
