...
# [EXPLOIT] Step 5: Create access keys for the admin user
...
# [EXPLOIT] Step 6: Switch to admin user credentials and verify new identity
...
# [OBSERVATION] Step 7: Verify administrator access
