...
echo "STARTING_USER=pl-prod-cloudformation-001-to-admin-starting-user"
echo "ADMIN_ROLE=pl-prod-cloudformation-001-to-admin-cfn-role"
echo "ADMIN_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cloudformation-001-to-admin-cfn-role"
echo "ESCALATED_ROLE_NAME=pl-prod-cloudformation-001-to-admin-escalated-role"
echo "ESCALATED_ROLE_NAME_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-cloudformation-001-to-admin-escalated-role"
