...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_one_hop_to_admin_ec2_modifyinstanceattribute_stopinstances_startinstances.value // empty')
...
echo "STARTING_USER=pl-prod-mia-to-admin-starting-user"
...
echo "TARGET_EC2_INSTANCE_TAG=pl-prod-mia-to-admin-target-instance"
