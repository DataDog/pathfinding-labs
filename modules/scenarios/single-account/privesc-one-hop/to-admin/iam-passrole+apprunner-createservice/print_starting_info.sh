...
echo "STARTING_USER=pl-prod-arcs-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-arcs-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-arcs-to-admin-target-role"
