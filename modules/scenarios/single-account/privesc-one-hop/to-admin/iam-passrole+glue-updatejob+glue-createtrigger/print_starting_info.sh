...
echo "STARTING_USER=pl-prod-guj-ct-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-guj-ct-to-admin-target-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-guj-ct-to-admin-target-role"
echo "INITIAL_ROLE=pl-prod-guj-ct-to-admin-initial-role"
echo "INITIAL_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-guj-ct-to-admin-initial-role"
