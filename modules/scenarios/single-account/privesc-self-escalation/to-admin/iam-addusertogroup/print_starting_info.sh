...
echo "START_USER=pl-aug-start-user"
echo "START_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-aug-start-user"
echo "ADMIN_GROUP=pl-aug-admin-group"
echo "ADMIN_GROUP_ARN=arn:aws:iam::${ACCOUNT_ID}:group/pl-aug-admin-group"
