...
MODULE_OUTPUT=$(terraform output -json 2>/dev/null | jq -r '.single_account_privesc_self_escalation_to_admin_iam_putgrouppolicy.value // empty')
...
echo "PRIVESC_USER=pl-pgp-paul"
echo "PRIVESC_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-pgp-paul"
echo "TARGET_GROUP=pl-pgp-escalation-group"
echo "TARGET_GROUP_ARN=arn:aws:iam::${ACCOUNT_ID}:group/pl-pgp-escalation-group"
