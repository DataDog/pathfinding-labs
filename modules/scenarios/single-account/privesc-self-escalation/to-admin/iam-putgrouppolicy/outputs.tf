...
output "attack_path" {
  ...
  value       = "pl-pgp-paul (member of pl-pgp-escalation-group) uses iam:PutGroupPolicy to add admin policy to their own group, escalating themselves to admin"
}