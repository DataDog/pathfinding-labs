# IAM Managed Role Policy Attachment to Admin
...
2. Navigate to `iam-009-to-admin` in the scenarios list
...
```bash
plabs disable iam-009-to-admin
plabs apply
```
