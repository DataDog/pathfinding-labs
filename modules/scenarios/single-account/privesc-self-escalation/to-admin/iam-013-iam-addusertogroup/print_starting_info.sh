...
echo "START_USER=pl-prod-iam-013-to-admin-user"
echo "START_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-013-to-admin-user"
echo "ADMIN_GROUP=pl-prod-iam-013-to-admin-group"
echo "ADMIN_GROUP_ARN=arn:aws:iam::${ACCOUNT_ID}:group/pl-prod-iam-013-to-admin-group"
