...
echo "PRIVESC_USER=pl-prod-iam-011-to-admin-paul"
echo "PRIVESC_USER_ARN=arn:aws:iam::${ACCOUNT_ID}:user/pl-prod-iam-011-to-admin-paul"
echo "TARGET_GROUP=pl-prod-iam-011-to-admin-escalation-group"
echo "TARGET_GROUP_ARN=arn:aws:iam::${ACCOUNT_ID}:group/pl-prod-iam-011-to-admin-escalation-group"
