...
echo "STARTING_USER=pl-prod-prp-to-admin-starting-user"
echo "STARTING_ROLE=pl-prod-prp-to-admin-starting-role"
echo "STARTING_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-prp-to-admin-starting-role"
