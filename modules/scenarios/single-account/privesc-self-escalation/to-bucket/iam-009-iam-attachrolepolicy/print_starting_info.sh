...
echo "STARTING_USER=pl-prod-iam-009-to-bucket-starting-user"
echo "STARTING_ROLE=pl-prod-iam-009-to-bucket-starting-role"
echo "STARTING_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-iam-009-to-bucket-starting-role"
