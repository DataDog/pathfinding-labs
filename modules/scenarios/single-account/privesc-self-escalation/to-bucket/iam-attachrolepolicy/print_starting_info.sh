...
echo "STARTING_USER=pl-prod-arp-to-bucket-starting-user"
echo "STARTING_ROLE=pl-prod-arp-to-bucket-starting-role"
echo "STARTING_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-arp-to-bucket-starting-role"
