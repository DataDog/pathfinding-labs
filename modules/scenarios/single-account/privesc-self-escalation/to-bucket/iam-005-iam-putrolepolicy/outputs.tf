...
output "attack_path" {
  ...
  value       = "User (pl-prod-iam-005-to-bucket-starting-user) → AssumeRole → Role (pl-prod-iam-005-to-bucket-starting-role) → PutRolePolicy (self) → AssumeRole → Target Role → S3 Bucket Access"
}
