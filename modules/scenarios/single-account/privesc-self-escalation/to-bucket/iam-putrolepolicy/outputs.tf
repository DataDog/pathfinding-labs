...
output "attack_path" {
  ...
  value       = "User (pl-prod-prp-to-bucket-starting-user) → AssumeRole → Role (pl-prod-prp-to-bucket-starting-role) → PutRolePolicy (self) → AssumeRole → Target Role → S3 Bucket Access"
}
