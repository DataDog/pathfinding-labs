...
echo "STARTING_USER_DEV=pl-dev-xsare-to-admin-starting-user"
echo "TARGET_ROLE_PROD=pl-prod-xsare-to-admin-target-role"
echo "TARGET_ROLE_PROD_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-xsare-to-admin-target-role"
