...
SENSITIVE_BUCKET_NAME=$(echo "$MODULE_OUTPUT" | jq -r '.sensitive_bucket_name')
SENSITIVE_BUCKET_ARN=$(echo "$MODULE_OUTPUT" | jq -r '.sensitive_bucket_arn')
...
echo "SENSITIVE_BUCKET_NAME=$SENSITIVE_BUCKET_NAME"
echo "SENSITIVE_BUCKET_ARN=$SENSITIVE_BUCKET_ARN"
