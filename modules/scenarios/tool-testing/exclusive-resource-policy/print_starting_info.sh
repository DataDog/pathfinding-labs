...
EXCLUSIVE_SENSITIVE_BUCKET_NAME=$(echo "$MODULE_OUTPUT" | jq -r '.exclusive_sensitive_bucket_name')
EXCLUSIVE_SENSITIVE_BUCKET_ARN=$(echo "$MODULE_OUTPUT" | jq -r '.exclusive_sensitive_bucket_arn')
...
echo "EXCLUSIVE_BUCKET_ACCESS_ROLE_ARN=$EXCLUSIVE_BUCKET_ACCESS_ROLE_ARN"
echo "EXCLUSIVE_SENSITIVE_BUCKET_NAME=$EXCLUSIVE_SENSITIVE_BUCKET_NAME"
echo "EXCLUSIVE_SENSITIVE_BUCKET_ARN=$EXCLUSIVE_SENSITIVE_BUCKET_ARN"
