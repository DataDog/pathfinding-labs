...
```bash
plabs enable test-effective-permissions-evaluation-to-bucket
plabs apply
```
...
2. Navigate to `test-effective-permissions-evaluation-to-bucket` in the scenarios list
...
```bash
plabs disable test-effective-permissions-evaluation-to-bucket
plabs apply
```
