...
echo "STARTING_USER=pl-prod-datapipeline-001-to-bucket-starting-user"
echo "PIPELINE_ROLE=pl-prod-datapipeline-001-to-bucket-pipeline-role"
echo "PIPELINE_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-datapipeline-001-to-bucket-pipeline-role"
