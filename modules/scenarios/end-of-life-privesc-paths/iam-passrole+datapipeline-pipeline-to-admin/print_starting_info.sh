...
echo "STARTING_USER=pl-prod-datapipeline-001-to-admin-starting-user"
echo "TARGET_ROLE=pl-prod-datapipeline-001-to-admin-pipeline-role"
echo "TARGET_ROLE_ARN=arn:aws:iam::${ACCOUNT_ID}:role/pl-prod-datapipeline-001-to-admin-pipeline-role"
