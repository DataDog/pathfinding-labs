# Pathfinder Labs Deployment Script

This directory will contain an interactive setup script that will ask the user information about their environment and guide them through the steps needed to get Pathfinder Labs working. 
...
* **Step 1:** Configure Pathfinder Labs' terraform.tfvars with the three AWS profiles to use for prod, dev, and ops (the script can ask for the three profiles and grab the account ids when it is testing to see if they all work.)
* **Step 2:** Deploy Pathfinder Labs
