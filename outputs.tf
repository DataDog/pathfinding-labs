...
output "prod_one_hop_to_admin_iam_putgrouppolicy_privesc_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_putgrouppolicy ? module.single_account_privesc_self_escalation_to_admin_iam_putgrouppolicy[0].privesc_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_putgrouppolicy_privesc_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_putgrouppolicy ? module.single_account_privesc_self_escalation_to_admin_iam_putgrouppolicy[0].privesc_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_addusertogroup_start_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_addusertogroup ? module.single_account_privesc_self_escalation_to_admin_iam_addusertogroup[0].start_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_addusertogroup_start_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_addusertogroup ? module.single_account_privesc_self_escalation_to_admin_iam_addusertogroup[0].start_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_attachuserpolicy_starting_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_attachuserpolicy ? module.single_account_privesc_self_escalation_to_admin_iam_attachuserpolicy[0].starting_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_attachuserpolicy_starting_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_attachuserpolicy ? module.single_account_privesc_self_escalation_to_admin_iam_attachuserpolicy[0].starting_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_attachgrouppolicy_starting_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_attachgrouppolicy ? module.single_account_privesc_self_escalation_to_admin_iam_attachgrouppolicy[0].starting_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_attachgrouppolicy_starting_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_attachgrouppolicy ? module.single_account_privesc_self_escalation_to_admin_iam_attachgrouppolicy[0].starting_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_attachgrouppolicy_group_name" {
  ...
  value       = var.enable_single_account_privesc_self_escalation_to_admin_iam_attachgrouppolicy ? module.single_account_privesc_self_escalation_to_admin_iam_attachgrouppolicy[0].group_name : null
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_starting_user_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].starting_user_name : null
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_starting_user_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].starting_user_arn : null
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_starting_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].starting_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_starting_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].starting_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_starting_role_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].starting_role_name : null
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_starting_role_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].starting_role_arn : null
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_admin_role_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].admin_role_name : null
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_admin_role_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].admin_role_arn : null
}
...
output "prod_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction_attack_path" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction ? module.single_account_privesc_one_hop_to_admin_iam_passrole_lambda_createfunction_lambda_invokefunction[0].attack_path_description : null
}
...
output "prod_one_hop_to_admin_iam_passrole_cloudformation_starting_user_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation ? module.single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation[0].starting_user_name : null
}
...
output "prod_one_hop_to_admin_iam_passrole_cloudformation_starting_user_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation ? module.single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation[0].starting_user_arn : null
}
...
output "prod_one_hop_to_admin_iam_passrole_cloudformation_starting_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation ? module.single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation[0].starting_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_passrole_cloudformation_starting_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation ? module.single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation[0].starting_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_passrole_cloudformation_admin_role_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation ? module.single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation[0].admin_role_name : null
}
...
output "prod_one_hop_to_admin_iam_passrole_cloudformation_admin_role_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation ? module.single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation[0].admin_role_arn : null
}
...
output "prod_one_hop_to_admin_iam_passrole_cloudformation_attack_path" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation ? module.single_account_privesc_one_hop_to_admin_iam_passrole_cloudformation[0].attack_path : null
}
...
output "prod_one_hop_to_admin_iam_createaccesskey_starting_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_createaccesskey ? module.single_account_privesc_one_hop_to_admin_iam_createaccesskey[0].starting_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_createaccesskey_starting_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_admin_iam_createaccesskey ? module.single_account_privesc_one_hop_to_admin_iam_createaccesskey[0].starting_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_passrole_ec2_runinstances_starting_user_access_key_id" {
  ...
  value       = try(module.single_account_privesc_one_hop_to_admin_iam_passrole_ec2_runinstances[0].starting_user_access_key_id, "not_enabled")
  sensitive   = true
}
...
output "prod_one_hop_to_admin_iam_passrole_ec2_runinstances_starting_user_secret_access_key" {
  ...
  value       = try(module.single_account_privesc_one_hop_to_admin_iam_passrole_ec2_runinstances[0].starting_user_secret_access_key, "not_enabled")
  sensitive   = true
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_starting_user_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].starting_user_name : null
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_starting_user_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].starting_user_arn : null
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_starting_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].starting_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_starting_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].starting_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_target_user_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].target_user_name : null
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_target_user_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].target_user_arn : null
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_original_password" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].original_password : null
  sensitive   = true
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_sensitive_bucket_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].sensitive_bucket_name : null
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_sensitive_bucket_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].sensitive_bucket_arn : null
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_console_login_url" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].console_login_url : null
}
...
output "prod_one_hop_to_bucket_iam_updateloginprofile_attack_path" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_updateloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_updateloginprofile[0].attack_path : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_starting_user_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].starting_user_name : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_starting_user_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].starting_user_arn : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_starting_user_access_key_id" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].starting_user_access_key_id : null
  sensitive   = true
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_starting_user_secret_access_key" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].starting_user_secret_access_key : null
  sensitive   = true
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_hop1_user_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].hop1_user_name : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_hop1_user_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].hop1_user_arn : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_sensitive_bucket_name" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].sensitive_bucket_name : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_sensitive_bucket_arn" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].sensitive_bucket_arn : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_console_login_url" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].console_login_url : null
}
...
output "prod_one_hop_to_bucket_iam_createloginprofile_attack_path_description" {
  ...
  value       = var.enable_single_account_privesc_one_hop_to_bucket_iam_createloginprofile ? module.single_account_privesc_one_hop_to_bucket_iam_createloginprofile[0].attack_path_description : null
}
